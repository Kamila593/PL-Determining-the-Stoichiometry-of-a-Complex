...
%3,153~mg chlorku żelaza(II) oraz 17,824~mg \textit{o}-fenantroliny. Substancje umieszczono w~kolbach stożkowych wraz z~pojemnikami, przy czym masę 3,153~mg \ce{FeCl2} do kolby o~pojemności 50~ml a~17,824~mg \textit{o}-fenantroliny do kolby o~pojemności 10~ml. Obie kolby stożkowe uzupełniono do kreski roztworem \ce{HCl} o~stężeniu 0,004~M.
...
%Istnieje tylko jeden punkt pomiarowy po przekroczeniu stechiometrycznej ilości \textit{o}--fenantroliny do jonów żelaza(II), który określiłby maksymalną wartość absorbancji. Widma przedstawione na Rysunku~3 potwierdzają, że wartości absorbancji zwiększały się wraz z~całkowitą objętością dodanego roztworu \textit{o}--fenantroliny i~nie sporządzono drugiego roztworu z~liczbą moli \textit{o}--fenantroliny przekraczającego stosunek stechiometryczny. Biorąc pod uwagę brak liniowości pierwszych ośmiu punktów, istnieją przesłanki do tego, by sądzić sądzić, że ten punkt pomiarowy może być niemniej wątpliwy. Zatem maksymalna wartość absorbancji może być inna, a~punkt przecięcia prostych może być obecny dla innej wartości stosunku molowego.


%Należy tu wspomnieć, że również punkt pomiarowy dla roztworu po przekroczeniu stosunku stechiometrycznego jest wątpliwy. Ponadto, tylko ten jeden punkt decyduje o~wyznaczeniu prostej - w~tym przypadku jest to możliwe, ponieważ jej współczynnik kierunkowy jest równy zeru. Jednakże, przeprowadzenie kilku pomiarów i~dopasowanie prostej do uzyskanych punktów pomiarowych umożliwiłoby uzyskanie bardziej wiarygodnego wyniku.


%Wyznaczone proste przecinają się dla stosunku molowego równego 3,8 $\approx$ 4, więc uzyskany wynik stechiometrii kompleksu to 4:1. Nie jest to wynik zgodny z~faktycznym, który wynosi 3:1. Należy tu również podkreślić, że pominięto sześć punktów pomiarowych, gdzie liczba wszystkich punktów pomiarowych wynosiła dziewięć. Metoda stosunków molowych nie dostarczyła zatem ani wyników zgodnych z~literaturowymi, ani spójnych.
